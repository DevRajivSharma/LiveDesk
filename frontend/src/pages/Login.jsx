        ...
        <div className="p-8 lg:p-16 flex flex-col justify-center relative bg-[#050505]">
          <div className="max-w-md mx-auto w-full">
            <div className="mb-10 text-center lg:text-left">
              <h1 className="text-3xl font-black text-white mb-2 tracking-tight uppercase">WELCOME_BACK</h1>
              <p className="text-slate-500 font-black text-[10px] uppercase tracking-[0.2em]">INITIALIZE_SESSION_PROTOCOL</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  <label className="block text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">ACCESS_KEY</label>
                  <Link to="/forgot-password" size="sm" className="text-[10px] font-black text-blue-500 hover:text-blue-400 uppercase tracking-widest underline underline-offset-4 decoration-blue-500/20">LOST_KEY?</Link>
                </div>
                <div className="relative group">
            ...
            <div className="mt-10">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-[9px] uppercase font-black tracking-[0.3em]">
                  <span className="bg-[#050505] px-4 text-slate-600">IDENTITY_PROVIDER_SYNC</span>
                </div>
              </div>
            ...
            <p className="mt-10 text-center text-slate-500 font-black text-[10px] uppercase tracking-widest">
              NEW_OPERATIVE? <Link to="/register" className="text-white hover:text-blue-500 font-black transition-colors underline underline-offset-8 decoration-white/20 hover:decoration-blue-500 ml-2">REGISTER_PROTOCOL</Link>
            </p>
          </div>
        </div>
      </div>
